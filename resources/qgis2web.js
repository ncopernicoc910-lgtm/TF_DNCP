...
map.getView().fit([-8419210.386129, -1281167.655956, -8301069.492331, -1191538.489736], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">DNCP EF</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (103 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'El presente mapa fue creado por Diego Nicolas Chavez Plasencia en el curso de Cartografia, ciclo 2025-2';
            }
